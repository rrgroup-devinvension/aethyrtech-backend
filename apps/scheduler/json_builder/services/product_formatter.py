...
class ProductFormatter:
    ...
    def set_basic(self, uid=None, keywords=None, status=None, target_keyword=None, platform=None, brand=None, title=None, description=None, availability=None, product_url=None, platform_type=None, scraped_date=None, scraper_id=None, platform_assured=None):
        self.uid = uid
    ...
    def to_catalog_json(self, is_competitor=False):
        base = {
            ...
            "msrp": f"Rs.{self.market_price:.2f}" if self.market_price else "Rs.0.00",
