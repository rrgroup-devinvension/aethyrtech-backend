...
from .service_layer import scheduler_tick as service_scheduler_tick
...
@shared_task
def scheduler_tick_task():
    """Thin Celery wrapper which delegates scheduling logic to service layer."""
    try:
        service_scheduler_tick()
    except Exception:
        logger.exception("scheduler_tick failed in service layer")
