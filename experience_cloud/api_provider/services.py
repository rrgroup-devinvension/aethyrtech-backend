...
class BaseApiClient:
    ...
    def _log_usage(self, status: str, response_time: float, request_size: int = 0, response_size: int = 0, log_context: LogContextSchema = None):
        if not log_context:
            log_context = {}
        ...
        for attempt in range(self.retry_count + 1):
            ...
            try:
                ...
                if attempt < self.retry_count:
                    ...
                    self._log_usage('FAILED', response_time, request_size, response_size, log_context)
