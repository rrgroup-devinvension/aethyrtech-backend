...
urlpatterns = [
    ...
    path("dashboard-positive/<int:region_id>/", DashboardPositiveDataView.as_view(), name="dashboard_positive_data_view"),
    ...
    path("incentive-insights/<int:region_id>/", IncentiveInsightsDataView.as_view(), name="incentive_insights_data_view"),
