...
PERMISSION_REGISTRY = [
    # IAM
    {"id": AppPermissions.READ_USER, "name": "Read Users", "group": "IAM", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View users and their details.", "implies": []},
    {"id": AppPermissions.CREATE_USER, "name": "Create Users", "group": "IAM", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Create new users in the system.", "implies": [AppPermissions.READ_USER]},
    ...
    {"id": AppPermissions.MANAGE_BRAND, "name": "Manage Brands", "group": "Taxonomy", "scopes": ["INTERNAL"], "description": "Full access to modify brands.", "implies": [AppPermissions.READ_BRAND]},
    {"id": AppPermissions.READ_TAXONOMY, "name": "Read Taxonomy", "group": "Taxonomy", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View taxonomy structures.", "implies": []},
    {"id": AppPermissions.MANAGE_TAXONOMY, "name": "Manage Taxonomy", "group": "Taxonomy", "scopes": ["INTERNAL"], "description": "Full access to modify taxonomy.", "implies": [AppPermissions.READ_TAXONOMY]},
    {"id": AppPermissions.READ_INTEGRATIONS, "name": "Read Integrations", "group": "Integrations", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View connected integrations.", "implies": []},
    {"id": AppPermissions.MANAGE_INTEGRATIONS, "name": "Manage Integrations", "group": "Integrations", "scopes": ["INTERNAL"], "description": "Configure and manage integrations.", "implies": [AppPermissions.READ_INTEGRATIONS]},

    # Market Data
    {"id": AppPermissions.READ_PRODUCTS, "name": "Read Products", "group": "Market Data", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View product catalog.", "implies": []},
    {"id": AppPermissions.UPDATE_PRODUCTS, "name": "Update Products", "group": "Market Data", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Modify existing products.", "implies": [AppPermissions.READ_PRODUCTS]},
    {"id": AppPermissions.DELETE_PRODUCTS, "name": "Delete Products", "group": "Market Data", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Remove products from catalog.", "implies": [AppPermissions.READ_PRODUCTS]},
    {"id": AppPermissions.VIEW_ANALYTICS, "name": "View Analytics", "group": "Market Data", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Access market analytics dashboards.", "implies": []},

    # Executions
    {"id": AppPermissions.READ_EXECUTIONS, "name": "Read Executions", "group": "Executions", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View execution logs and history.", "implies": []},
    {"id": AppPermissions.START_EXECUTION, "name": "Start Execution", "group": "Executions", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Initiate new executions.", "implies": [AppPermissions.READ_EXECUTIONS]},
    {"id": AppPermissions.STOP_EXECUTION, "name": "Stop Execution", "group": "Executions", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Halt running executions.", "implies": [AppPermissions.READ_EXECUTIONS]},
    {"id": AppPermissions.MANAGE_SCHEDULERS, "name": "Manage Schedulers", "group": "Executions", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Configure execution schedulers.", "implies": [AppPermissions.READ_EXECUTIONS]},
    {"id": AppPermissions.READ_TASKS, "name": "Read Tasks", "group": "Executions", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View background task queue.", "implies": []},

    # Roles
    {"id": AppPermissions.READ_ROLES, "name": "Read Roles", "group": "IAM", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View roles and their permissions.", "implies": []},
    {"id": AppPermissions.CREATE_ROLE, "name": "Create Roles", "group": "IAM", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Create new custom roles.", "implies": [AppPermissions.READ_ROLES]},
    {"id": AppPermissions.UPDATE_ROLE, "name": "Update Roles", "group": "IAM", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Modify existing roles and permissions.", "implies": [AppPermissions.READ_ROLES]},
    {"id": AppPermissions.DELETE_ROLE, "name": "Delete Roles", "group": "IAM", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Delete custom roles.", "implies": [AppPermissions.READ_ROLES]},

    # Dashboard & General
    {"id": AppPermissions.READ_DASHBOARD, "name": "Read Dashboard", "group": "General", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Access the main dashboard.", "implies": []},
    ...
    {"id": AppPermissions.READ_MARKET_DATA_DUMP, "name": "Read Market Data Dump", "group": "Insights", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Access raw market data exports.", "implies": []},
    {"id": AppPermissions.READ_GEN_INSIGHTS, "name": "Read Gen Insights", "group": "Insights", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "Access AI-generated market insights.", "implies": []},
    {"id": AppPermissions.READ_EXPERIANCE_DASHBOARD, "name": "Read Experience Dashboard", "group": "Insights", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View digital experience metrics.", "implies": []},
    {"id": AppPermissions.READ_RISK_CENTER, "name": "Read Risk Center", "group": "Insights", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View risk analysis dashboards.", "implies": []},
    {"id": AppPermissions.READ_GROWTH_LEVER, "name": "Read Growth Lever", "group": "Insights", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View growth opportunity analysis.", "implies": []},
    {"id": AppPermissions.READ_CRO_BARRIERS, "name": "Read CRO Barriers", "group": "Insights", "scopes": ["INTERNAL", "ORGANIZATION"], "description": "View conversion rate optimization data.", "implies": []},
