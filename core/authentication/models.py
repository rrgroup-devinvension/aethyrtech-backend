...
class LoginHistory(BaseModel):
    user = models.ForeignKey('core_users.User', on_delete=models.CASCADE, related_name="login_history")
...
class PasswordResetOTP(BaseModel):
    ...
    user = models.ForeignKey('core_users.User', on_delete=models.CASCADE, related_name="password_reset_otps")
