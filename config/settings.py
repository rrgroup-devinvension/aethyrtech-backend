...
# Use console backend for testing, change to smtp for production
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Aethyrtech Platform <noreply@aethyrtech.com>')
